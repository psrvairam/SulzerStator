...
public:
  ...
  SPLINE splineClustering(vector<Param> *distrPtsFile);
	...
	/*! \brief makes 2D block mesh by rotating spline
	 *
	 * 	\param bottom lower spline
	 * 	\param span angle of the mesh
	...
	STRUCTMESH structBlockMesh2DRotate(SPLINE &bottom, double angle, const int imax, const int jmax);
